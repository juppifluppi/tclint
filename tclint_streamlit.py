...
### Version 1.1 (29.11.22): https://github.com/juppifluppi/tclint
...
for w in cfmmx:
    cd = w / 10
    cf = 90.62889 + ( 35.36033 * ( ( np.log( 1 / 1 + 2.718281828459045 ** ( -0.9872289 + cd ) ) ) / 2.4925333 ) )
    cfmm.append(cf)
    zu.append(cd)
...
ax.plot(zu, cfmm, color='grey',alpha=0.5, linewidth=2)
...
st.caption("Version 1.1 (29.11.22). Visit the [github page](https://github.com/juppifluppi/tclint) for more information and a downloadable version.")
