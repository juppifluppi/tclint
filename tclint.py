...
# load training (x,y,fil) and test set data (x2,y2,fil2)
...
# if SMILES codes are given as input: protonate and pretreat given SMILES, compute descriptors via rdkit/scopy, calculate probability    
...
try:
    ...
    print("TC/L interaction probability: " + str(int(round(tcl3*100,0))) + " %")
    print("---------------------------------")  
