...
This web application is not actively maintained anymore as the model is now integrated in our [new web application](https://kehrein.xyz/muctcl) incorporating drug-bile with drug-mucin interactions!
